...
<div class="dash__block">
	...
	<form class="request" method="POST" action="/admin/roster/{{ $date->format('m-Y') }}">
		...
		<div class="form-group">
			<label for="input_employee">Employee <span class="request__validate">(ID - Title - Full Name)</span></label>
		...
		<div class="form-group">
			<label for="input_date">Date <span class="request__validate">(dd/mm/yyyy)</span></label>
				<input name="date" type="date" id="input_date" class="form-control request__input" value="{{ old('date') ? old('date') : $date->startOfMonth()->format('Y-m-d') }}" autofocus>
		</div>
...
<div class="dash__block">
	...
	<div class="form-group">
    <label for="input_month_year">Date <span class="request__validate">(Select a dropdown item to go to month)</span></label>
    <select name="month_year" id="input_month_year" class="form-control request__input" onchange="location = '/admin/roster/' + this.value">
