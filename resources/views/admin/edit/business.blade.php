...
<body class="dashboard">
	...
	<div class="dash__block">
		...
		<form class="request" method="POST" href="/admin/edit" enctype="multipart/form-data">
			{{ csrf_field() }}
			<div class="form-group request__flex-container">
				<div class="request__flex request__flex--left">
					<label for="inputImg">Business Logo<span class="request__validate"> (840x240 default resolution)</span></label>
					<input name="businesslogo" type="file" id="inputImg"></input>
				</div>
