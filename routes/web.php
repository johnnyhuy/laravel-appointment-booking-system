...
Route::get('/admin/employees/assign', 'EmployeeController@assignEmployees');
Route::get('/admin/employees/assign/{employee_id}', 'EmployeeController@assignEmployees');
...
Route::post('/admin/employees/assign/{employee_id}', "BookingController@assignEmployee");
